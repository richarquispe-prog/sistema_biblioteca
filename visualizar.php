                ...
                <form method="post">
                    ...
                    <div id="main-containe">
                        <div class="container">
                            ...
                            <div class="mb-3">
                                <label>Editorial:</label><input type="text" name="autor" class="form-control"
                                    aria-label="Disabled input example" disabled
                                    value="<?php echo $mostrar['editorial'] ?>">
                            </div>
                            <div class="mb-3">
                                <label>Estado:</label><input type="text" name="titulo" class="form-control"
                                    aria-label="Disabled input example" disabled
                                    value="<?php echo $mostrar['estado'] ?>">
                            </div>
                            <div class="mb-3">
                                <label>Formato:</label><input type="text" name="titulo" class="form-control"
                                    aria-label="Disabled input example" disabled
                                    value="<?php echo $mostrar['formato'] ?>">
                            </div>
                            <center> <a href="catalogo.php" class="btn btn-secondary">Volver</a>
                                <a class="btn btn-success" target="_black"
                                    href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/bibliotecaepis/' . $mostrar['PDF']; ?>">Descargar
                                    PDF</a>
...
while($mostrar=mysqli_fetch_array($result)){
	if ($mostrar['cantidad'] == 1) {
		 ?>
                                ...
                                <a href="boleta.php?n_control= <?php echo $mostrar['n_control'];?>"
                                    class="btn btn-primary">Solicitar Libro</a>
