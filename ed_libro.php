    ...
    <div class="row">
        <div class="col-lg-6 m-auto">
            <div class="card shadow mb-4">
                ...
                <form action="editarCodigo_libro.php" method="post">


                    <div id="main-containe">
                        <div class="container">
                            <div class="mb-3">
                                <input type="hidden" name="n_control" class="form-control"
                                    value="<?php echo $mostrar['n_control'] ?>">
                            </div>
                            <div class="mb-3">
                                <label>Dewey:</label><input type="text" name="dewewey" class="form-control"
                                    value="<?php echo $mostrar['dewey'] ?>">
                            </div>
                            <div class="mb-3">
