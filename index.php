...
<style>
    ...
    .dropdown:hover ul ,dropdown:hover ul.show{
        max-height: 400px;
        color: #fff;
    ...
    *, *:before, *:after {
    ...
    .nav__social a, .nav__social a:visited,
    .nav__enlaces a,
    ...
    .cabecera {
        display: inline-block;
        height: 275px;/*cambio original 375-*/
        left: 0;
        padding: 0 20px;
        position: absolute;
        top: 0;
    ...
    .cabecera h1 {
        ...
        margin: 0px 0;/*AQUI HICE CAMBIOS*/
        text-transform: uppercase;
        color:#ffffff;
    }
    .cabecera p {
    ...
    .cabecera__contenido {
        ...
        height: 55px;/*aqui hice cambio 155*/
        left: 0;
        margin-top: 10px;
        padding: 40px 20px;
        position: fixed;
    ...
    .cabecera, .cabecera__fondo--nitido {
    ...
    .cabecera__capa {
        ...
        top: 0;
        z-index: 1;
        width: 100%;/* se cambia de 100% a:*/
        max-width:150%;/* se cambia de 150% a:*/
        min-width: 50%;/* se cambia de 100% a:*/
