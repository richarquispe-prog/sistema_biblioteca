...
if ($_POST) {
	...
	$archivo =$_FILES['imagen']['tmp_name'];//se guarda con file y se guarda temporalmente
...
<link rel="stylesheet" type="text/css" href="Styles/estilos_pdf.css">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <input type="text" name="dewewey" placeholder="Número de Deewey" class="form-control"
                                required="">
                        </div>
                        ...
                        <center> <a href="acervo.php" class="btn btn-secondary">Cancelar</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="example" class="table table-sm" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td><a href="eliminar_libro.php?n_control=<?php echo $mostrar['n_control']; ?>"
