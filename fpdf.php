...
$pdf->Ln();
$pdf->image("img/unh.png", 10, 10, 30, 30, 'PNG');
$pdf->image("img/epis1.png", 180, 10, 30, 30, 'PNG');
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(20,5,$mostrar['nombre'],0,1,'L');

$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(20, 5, utf8_decode("Apellidos: "), 0, 0, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(20,5,$mostrar['apellidos'],0,1,'L');
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(20,5,$mostrar['titulo'],0,1,'L');
